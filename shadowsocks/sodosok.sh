#!/bin/bash
#shadowsocks-libev obfs install by Gashakgeneration22
...
# Link Hosting Kalian
Gashakgeneration22="raw.githubusercontent.com/Gashakgeneration22/joesatria-vpn/main/shadowsocks"
...
cd /usr/bin
wget -O addss "https://${Gashakgeneration22}/addss.sh"
wget -O delss "https://${Gashakgeneration22}/delss.sh"
wget -O cekss "https://${Gashakgeneration22}/cekss.sh"
wget -O renewss "https://${Gashakgeneration22}/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x renewss
