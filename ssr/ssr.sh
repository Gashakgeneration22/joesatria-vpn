...
# Link Hosting Kalian
Gashakgeneration22="raw.githubusercontent.com/Gashakgeneration22/joesatria-vpn/main/ssr"
...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://${Gashakgeneration22}/ssrmu"
...
Install_SSR
wget -O /usr/bin/ssr https://${Gashakgeneration22}/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/addssr https://${Gashakgeneration22}/addssr.sh && chmod +x /usr/bin/addssr
wget -O /usr/bin/delssr https://${Gashakgeneration22}/delssr.sh && chmod +x /usr/bin/delssr
wget -O /usr/bin/renewssr https://${Gashakgeneration22}/renewssr.sh && chmod +x /usr/bin/renewssr
