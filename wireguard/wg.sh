...
# ==================================================
# Link Hosting Kalian
Gashakgeneration22="raw.githubusercontent.com/Gashakgeneration22/joesatria-vpn/main/wireguard"
...
echo -e "${Info} Wireguard Script By Gashakgeneration22"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://${Gashakgeneration22}/addwg.sh"
wget -O delwg "https://${Gashakgeneration22}/delwg.sh"
wget -O renewwg "https://${Gashakgeneration22}/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
