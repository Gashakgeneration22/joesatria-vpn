...
# Link Hosting Kalian
Gashakgeneration22="raw.githubusercontent.com/Gashakgeneration22/joesatria-vpn/main/sstp"
...
touch /var/lib/Gashakgeneration22/data-user-sstp
...
email=Gashakgeneration22@gmail.com
...
wget -O /etc/accel-ppp.conf "https://${Gashakgeneration22}/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/addsstp https://${Gashakgeneration22}/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://${Gashakgeneration22}/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://${Gashakgeneration22}/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/renewsstp https://${Gashakgeneration22}/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
