...
# ==================================================
# Link Hosting Kalian
Gashakgeneration22="raw.githubusercontent.com/Gashakgeneration22/joesatria-vpn/main/ipsec"
...
wget -O /usr/bin/addl2tp https://${Gashakgeneration22}/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://${Gashakgeneration22}/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://${Gashakgeneration22}/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://${Gashakgeneration22}/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://${Gashakgeneration22}/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://${Gashakgeneration22}/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
touch /var/lib/Gashakgeneration22/data-user-l2tp
touch /var/lib/Gashakgeneration22/data-user-pptp
rm -f /root/ipsec.sh
