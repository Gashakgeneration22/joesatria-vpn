...
# Script By Gashakgeneration22
# @ Copyrigt 2021 By Gashakgeneration22
# =====================================================
  ...
  "inbounds": [
    {
      ...
      "settings": {
        "clients": [
          {
            "password": "Gashakgeneration22Project"
#xray-trojan
          }
        ],
        "fallbacks": [
...
[Unit]
Description=Xray Service ( %i ) By Gashakgeneration22
...
[Unit]
Description=Trojan-Go Service By Gashakgeneration22
Documentation=https://t.me/Gashakgeneration22
Documentation=https://github.com/Gashakgeneration22/Gashakgeneration22
After=network.target nss-lookup.target
